...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.un239');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/img_8430-1314.jpeg':'images/img_8430-657.jpeg');
var a='data-src';var e=document.querySelector('.un241');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/hua-xiang-3-1058.jpg':'images/hua-xiang-3-529.jpg');

var a='data-src';var e=document.querySelector('.un244');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/godsgarden-logo6-400-1.png':'images/godsgarden-logo6-200-1.png');

var e=document.querySelector('.un233');e.setAttribute('src',(dpi>1)?'images/godsgarden-logo6-978.png':'images/godsgarden-logo6-489.png');
var e=document.querySelector('.un236');e.setAttribute('src',(dpi>1)?'images/hua-xiang-86-1070.jpg':'images/hua-xiang-86-535.jpg');
};
...
wl=new woolite();
wl.init();
wl.addAnimation($('.un234'), "2.00s", "0.00s", 1, 100);
wl.addAnimation($('.un235'), "3.10s", "0.00s", 1, 1);
wl.addAnimation($('.un237'), "3.00s", "0.00s", 1, 100);
wl.addAnimation($('.un240'), "1.00s", "0.00s", 1, 100);
wl.addAnimation($('.un242'), "3.10s", "0.00s", 1, 0);
wl.start();
if(location.hash){var e=location.hash.replace("#",""),o=function(){var t=document.querySelectorAll('[name="'+e+'"]')[0];t&&t.scrollIntoView(),"0px"===window.getComputedStyle(document.body).getPropertyValue("min-width")&&setTimeout(o,100)};o()}

});lfn=function(){ldsrcset('.un245 source');ldsrcset('.un246 source');ldsrcset('.un247 source');ldsrcset('.un248 source');ldsrcset('.un249 source');};if(document.readyState=="complete"){lfn();}else{$(window).on("load",lfn);}