...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.un25');e.setAttribute('src',(dpi>1)?'images/image_7-26.png':'images/image_7-13.png');
var e=document.querySelector('.un28');e.setAttribute('src',(dpi>1)?'images/image_7-26.png':'images/image_7-13.png');
...
var e=document.querySelector('.un48');e.setAttribute('src',(dpi>1)?'images/image_7-26-1.png':'images/image_7-13-1.png');
...
wl=new woolite();
wl.init();
wl.addAnimation($('.un22'), "1.00s", "0.00s", 8, 100);
wl.addAnimation($('.un26'), "1.00s", "0.00s", 8, 100);
wl.addAnimation($('.un27'), "1.00s", "0.00s", 8, 100);
wl.addAnimation($('.un29'), "1.00s", "0.00s", 8, 100);
wl.addAnimation($('.un49'), "1.00s", "0.00s", 8, 100);
wl.start();
...
});lfn=function(){ldsrcset('.un96 source');ldsrcset('.un97 source');ldsrcset('.un98 source');ldsrcset('.un99 source');ldsrcset('.un100 source');ldsrcset('.un101 source');ldsrcset('.un102 source');ldsrcset('.un103 source');ldsrcset('.un104 source');ldsrcset('.un105 source');ldsrcset('.un106 source');ldsrcset('.un107 source');ldsrcset('.un108 source');ldsrcset('.un109 source');ldsrcset('.un110 source');ldsrcset('.un111 source');ldsrcset('.un112 source');ldsrcset('.un113 source');ldsrcset('.un114 source');ldsrcset('.un115 source');ldsrcset('.un116 source');ldsrcset('.un117 source');ldsrcset('.un118 source');ldsrcset('.un119 source');ldsrcset('.un120 source');ldsrcset('.un121 source');ldsrcset('.un122 source');ldsrcset('.un123 source');ldsrcset('.un124 source');ldsrcset('.un125 source');ldsrcset('.un126 source');ldsrcset('.un127 source');};if(document.readyState=="complete"){lfn();}else{$(window).on("load",lfn);}