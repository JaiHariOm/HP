...
var a='data-src';var e=document.querySelector('.js532');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/godsgarden-logo6-400-1.png':'images/godsgarden-logo6-200-1.png');
...
ldsrc('.js528');ldsrcset('.js533 source');ldsrc('.js529');ldsrcset('.js534 source');ldsrc('.js531');ldsrcset('.js535 source');ldsrc('.js532');ldsrcset('.js536 source');wl=new woolite();
wl.init();
