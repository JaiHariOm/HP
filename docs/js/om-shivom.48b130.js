...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.js542');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/fire_dragon-jacket1-958.jpg':'images/fire_dragon-jacket1-479.jpg');


var a='data-src';var e=document.querySelector('.js546');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/artistphoto-816-1.jpg':'images/artistphoto-408-1.jpg');

var a='data-src';var e=document.querySelector('.js549');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/godsgarden-logo6-400-1.png':'images/godsgarden-logo6-200-1.png');

var e=document.querySelector('.js538');e.setAttribute('src',(dpi>1)?'images/godsgarden-logo6-1020.png':'images/godsgarden-logo6-510.png');
};
if(!window.HTMLPictureElement){r();}
(function(){$('a[href^="#"]:not(.allowConsent,.noConsent,.denyConsent,.removeConsent)').each(function(i,e){$(e).click(function(){var t=e.hash.length>1?$('[name="'+e.hash.slice(1)+'"]').offset().top:0;return $("html, body").animate({scrollTop:t},400),!1})})})();
ldsrc('.js542');ldsrcset('.js550 source');ldsrc('.js544');ldsrcset('.js551 source');ldsrc('.js545');ldsrcset('.js552 source');ldsrc('.js546');ldsrcset('.js553 source');ldsrc('.js548');ldsrcset('.js554 source');ldsrc('.js549');ldsrcset('.js555 source');wl=new woolite();
wl.init();
wl.addAnimation($('.js539')[0], "2.00s", "0.00s", 1, 100);
wl.addAnimation($('.js540')[0], "3.10s", "0.00s", 1, 1);
wl.addAnimation($('.js543')[0], "3.00s", "0.00s", 1, 100);
wl.addAnimation($('.js547')[0], "3.10s", "0.00s", 1, 0);
wl.start();
