...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.un285');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/atisuto-878.jpg':'images/atisuto-439.jpg');

var a='data-src';var e=document.querySelector('.un287');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/godsgarden-logo6-400.png':'images/godsgarden-logo6-200.png');
var a='data-src';var e=document.querySelector('.un288');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/img_8430-1314.jpeg':'images/img_8430-657.jpeg');
...
wl.addAnimation($('.un289'), "1.00s", "0.00s", 1, 100);
wl.start();
