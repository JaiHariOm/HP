...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.un221');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/img_8430-1314.jpeg':'images/img_8430-657.jpeg');
var a='data-src';var e=document.querySelector('.un223');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/hua-xiang-3-1058.jpg':'images/hua-xiang-3-529.jpg');

var a='data-src';var e=document.querySelector('.un226');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/godsgarden-logo6-400-1.png':'images/godsgarden-logo6-200-1.png');

var e=document.querySelector('.un215');e.setAttribute('src',(dpi>1)?'images/godsgarden-logo6-978.png':'images/godsgarden-logo6-489.png');
var e=document.querySelector('.un218');e.setAttribute('src',(dpi>1)?'images/hua-xiang-86-1070.jpg':'images/hua-xiang-86-535.jpg');
};
...
wl=new woolite();
wl.init();
wl.addAnimation($('.un216'), "2.00s", "0.00s", 1, 100);
wl.addAnimation($('.un217'), "3.10s", "0.00s", 1, 1);
wl.addAnimation($('.un219'), "3.00s", "0.00s", 1, 100);
wl.addAnimation($('.un222'), "1.00s", "0.00s", 1, 100);
wl.addAnimation($('.un224'), "3.10s", "0.00s", 1, 0);
wl.start();
...
});lfn=function(){ldsrcset('.un227 source');ldsrcset('.un228 source');ldsrcset('.un229 source');ldsrcset('.un230 source');ldsrcset('.un231 source');};if(document.readyState=="complete"){lfn();}else{$(window).on("load",lfn);}