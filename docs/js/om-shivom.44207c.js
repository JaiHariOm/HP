...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.un202');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/artistphoto-816-1.jpg':'images/artistphoto-408-1.jpg');

var a='data-src';var e=document.querySelector('.un205');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/godsgarden-logo6-400-1.png':'images/godsgarden-logo6-200-1.png');

var e=document.querySelector('.un194');e.setAttribute('src',(dpi>1)?'images/godsgarden-logo6-1020.png':'images/godsgarden-logo6-510.png');

var a='data-src';var e=document.querySelector('.un198');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/fire_dragon-jacket1-958.jpg':'images/fire_dragon-jacket1-479.jpg');
};
...
wl=new woolite();
wl.init();
wl.addAnimation($('.un195'), "2.00s", "0.00s", 1, 100);
wl.addAnimation($('.un196'), "3.10s", "0.00s", 1, 1);
wl.addAnimation($('.un199'), "3.00s", "0.00s", 1, 100);
wl.addAnimation($('.un203'), "3.10s", "0.00s", 1, 0);
wl.start();
if(location.hash){var e=location.hash.replace("#",""),o=function(){var t=document.querySelectorAll('[name="'+e+'"]')[0];t&&t.scrollIntoView(),"0px"===window.getComputedStyle(document.body).getPropertyValue("min-width")&&setTimeout(o,100)};o()}

});lfn=function(){ldsrcset('.un206 source');ldsrcset('.un207 source');ldsrcset('.un208 source');ldsrcset('.un209 source');ldsrcset('.un210 source');ldsrcset('.un211 source');};if(document.readyState=="complete"){lfn();}else{$(window).on("load",lfn);}