...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.un204');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/img_8430-1280-1.jpeg':'images/img_8430-640-1.jpeg');
var a='data-src';var e=document.querySelector('.un205');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/artistphoto-816-1.jpg':'images/artistphoto-408-1.jpg');

var a='data-src';var e=document.querySelector('.un208');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/godsgarden-logo6-400-1.png':'images/godsgarden-logo6-200-1.png');
var e=document.querySelector('.un197');e.setAttribute('src',(dpi>1)?'images/img_8430-1920-1.jpeg':'images/img_8430-960-1.jpeg');
var e=document.querySelector('.un198');e.setAttribute('src',(dpi>1)?'images/godsgarden-logo6-1116-1.png':'images/godsgarden-logo6-558-1.png');

var e=document.querySelector('.un202');e.setAttribute('src',(dpi>1)?'images/madoromi-with-light-690-1.jpg':'images/madoromi-with-light-345-1.jpg');};
