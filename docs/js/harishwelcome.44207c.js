...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.un165');e.setAttribute('src',(dpi>1)?'images/harishbg-1920.jpg':'images/harishbg-960.jpg');
...
wl=new woolite();
wl.init();
wl.addAnimation($('.un170'), "1.00s", "0.00s", 8, 100);
wl.start();
if(location.hash){var e=location.hash.replace("#",""),o=function(){var t=document.querySelectorAll('[name="'+e+'"]')[0];t&&t.scrollIntoView(),"0px"===window.getComputedStyle(document.body).getPropertyValue("min-width")&&setTimeout(o,100)};o()}

});lfn=function(){ldsrcset('.un174 source');ldsrcset('.un175 source');ldsrcset('.un176 source');};if(document.readyState=="complete"){lfn();}else{$(window).on("load",lfn);}