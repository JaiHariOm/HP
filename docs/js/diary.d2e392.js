...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.js399');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/object000_1-370.jpg':'images/object000_1-185.jpg');


var e=document.querySelector('.js396');e.setAttribute('src',(dpi>1)?'images/shapeimage_4-1264.jpg':'images/shapeimage_4-632.jpg');
var e=document.querySelector('.js397');e.setAttribute('src',(dpi>1)?'images/object000-360.jpg':'images/object000-180.jpg');
var e=document.querySelector('.js398');e.setAttribute('src',(dpi>1)?'images/object002-370.jpg':'images/object002-185.jpg');};
if(!window.HTMLPictureElement){r();}
(function(){$('a[href^="#"]:not(.allowConsent,.noConsent,.denyConsent,.removeConsent)').each(function(i,e){$(e).click(function(){var t=e.hash.length>1?$('[name="'+e.hash.slice(1)+'"]').offset().top:0;return $("html, body").animate({scrollTop:t},400),!1})})})();
ldsrc('.js399');ldsrcset('.js400 source');
});