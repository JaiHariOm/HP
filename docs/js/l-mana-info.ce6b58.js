...
ldsrc('.js64');ldsrcset('.js96 source');ldsrc('.js65');ldsrcset('.js97 source');ldsrc('.js66');ldsrcset('.js98 source');ldsrc('.js67');ldsrcset('.js99 source');ldsrc('.js68');ldsrcset('.js100 source');ldsrc('.js69');ldsrcset('.js101 source');ldsrc('.js70');ldsrcset('.js102 source');ldsrc('.js71');ldsrcset('.js103 source');ldsrc('.js72');ldsrcset('.js104 source');ldsrc('.js73');ldsrcset('.js105 source');ldsrc('.js74');ldsrcset('.js106 source');ldsrc('.js75');ldsrcset('.js107 source');ldsrc('.js76');ldsrcset('.js108 source');ldsrc('.js77');ldsrcset('.js109 source');ldsrc('.js78');ldsrcset('.js110 source');ldsrc('.js79');ldsrcset('.js111 source');ldsrc('.js80');ldsrcset('.js112 source');ldsrc('.js81');ldsrcset('.js113 source');ldsrc('.js82');ldsrcset('.js114 source');ldsrc('.js83');ldsrcset('.js115 source');ldsrc('.js84');ldsrcset('.js116 source');ldsrc('.js85');ldsrcset('.js117 source');ldsrc('.js86');ldsrcset('.js118 source');ldsrc('.js87');ldsrcset('.js119 source');ldsrc('.js88');ldsrcset('.js120 source');ldsrc('.js89');ldsrcset('.js121 source');ldsrc('.js90');ldsrcset('.js122 source');ldsrc('.js91');ldsrcset('.js123 source');ldsrc('.js92');ldsrcset('.js124 source');ldsrc('.js93');ldsrcset('.js125 source');ldsrc('.js94');ldsrcset('.js126 source');ldsrc('.js95');ldsrcset('.js127 source');wl=new woolite();
wl.init();
wl.addAnimation($('.js22')[0], "1.00s", "0.00s", 8, 100);
wl.addAnimation($('.js26')[0], "1.00s", "0.00s", 8, 100);
wl.addAnimation($('.js27')[0], "1.00s", "0.00s", 8, 100);
wl.addAnimation($('.js29')[0], "1.00s", "0.00s", 8, 100);
wl.addAnimation($('.js49')[0], "1.00s", "0.00s", 8, 100);
wl.start();
