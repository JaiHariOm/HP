...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js506');e.setAttribute('src',(dpi>1)?'images/harishbg-1920.jpg':'images/harishbg-960.jpg');
...
ldsrc('.js512');ldsrcset('.js515 source');ldsrc('.js513');ldsrcset('.js516 source');ldsrc('.js514');ldsrcset('.js517 source');wl=new woolite();
wl.init();
wl.addAnimation($('.js511')[0], "1.00s", "0.00s", 8, 100);
wl.start();
