...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.un186');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/img_8430-1280-1.jpeg':'images/img_8430-640-1.jpeg');
var a='data-src';var e=document.querySelector('.un187');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/artistphoto-816-1.jpg':'images/artistphoto-408-1.jpg');

var a='data-src';var e=document.querySelector('.un190');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/godsgarden-logo6-400-1.png':'images/godsgarden-logo6-200-1.png');
var e=document.querySelector('.un179');e.setAttribute('src',(dpi>1)?'images/img_8430-1920-1.jpeg':'images/img_8430-960-1.jpeg');
var e=document.querySelector('.un180');e.setAttribute('src',(dpi>1)?'images/godsgarden-logo6-1116-1.png':'images/godsgarden-logo6-558-1.png');

var e=document.querySelector('.un184');e.setAttribute('src',(dpi>1)?'images/madoromi-with-light-690-1.jpg':'images/madoromi-with-light-345-1.jpg');};
...
wl=new woolite();
wl.init();
wl.addAnimation($('.un181'), "2.00s", "0.00s", 1, 100);
wl.addAnimation($('.un182'), "3.10s", "0.00s", 1, 1);
wl.addAnimation($('.un185'), "3.00s", "0.00s", 1, 100);
wl.addAnimation($('.un188'), "3.10s", "0.00s", 1, 0);
wl.start();
...
});lfn=function(){ldsrcset('.un191 source');ldsrcset('.un192 source');ldsrcset('.un193 source');ldsrcset('.un194 source');};if(document.readyState=="complete"){lfn();}else{$(window).on("load",lfn);}