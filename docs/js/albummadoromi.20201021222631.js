...
r=function(){dpi=window.devicePixelRatio;$('.js324').attr('src', (dpi>1) ? 'images/img_8430-1280.jpeg' : 'images/img_8430-640.jpeg');
var a='data-src'; if($('.js325').hasAttr('src')) { a='src'; } $('.js325').attr(a, (dpi>1) ? 'images/artistphoto-816.jpg' : 'images/artistphoto-408.jpg');
$('.js326').attr('src', (dpi>1) ? 'images/godsgarden-logo6-400.png' : 'images/godsgarden-logo6-200.png');
...
wl.addAnimation($('.js325')[0], "3.10s", "0.00s", 1, 100);
wl.start();
