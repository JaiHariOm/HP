...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js509');e.setAttribute('src',(dpi>1)?'images/harishbg-1920.jpg':'images/harishbg-960.jpg');
...
ldsrc('.js515');ldsrcset('.js518 source');ldsrc('.js516');ldsrcset('.js519 source');ldsrc('.js517');ldsrcset('.js520 source');wl=new woolite();
wl.init();
wl.addAnimation($('.js514')[0], "1.00s", "0.00s", 8, 100);
wl.start();
