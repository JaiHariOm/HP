...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.un164');e.setAttribute('src',(dpi>1)?'images/harishbg-1920.jpg':'images/harishbg-960.jpg');
...
wl=new woolite();
wl.init();
wl.addAnimation($('.un169'), "1.00s", "0.00s", 8, 100);
wl.start();
...
});lfn=function(){ldsrcset('.un173 source');ldsrcset('.un174 source');ldsrcset('.un175 source');};if(document.readyState=="complete"){lfn();}else{$(window).on("load",lfn);}