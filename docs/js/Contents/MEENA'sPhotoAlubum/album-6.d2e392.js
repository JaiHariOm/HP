...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.js371');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'../../images/00000315-296.jpg':'../../images/00000315-148.jpg');
...
var e=document.querySelector('.js369');e.setAttribute('src',(dpi>1)?'../../images/shapeimage_4-1264.jpg':'../../images/shapeimage_4-632.jpg');
...
ldsrc('.js371');ldsrcset('.js384 source');ldsrc('.js372');ldsrcset('.js385 source');ldsrc('.js375');ldsrcset('.js386 source');ldsrc('.js376');ldsrcset('.js387 source');ldsrc('.js377');ldsrcset('.js388 source');ldsrc('.js379');ldsrcset('.js389 source');ldsrc('.js380');ldsrcset('.js390 source');ldsrc('.js381');ldsrcset('.js391 source');ldsrc('.js382');ldsrcset('.js392 source');ldsrc('.js383');ldsrcset('.js393 source');
});