...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.un214');e.setAttribute('src',(dpi>1)?'../../images/shapeimage_4-1264.jpg':'../../images/shapeimage_4-632.jpg');

var a='data-src';var e=document.querySelector('.un216');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'../../images/00000315-296.jpg':'../../images/00000315-148.jpg');
...
});lfn=function(){ldsrcset('.un229 source');ldsrcset('.un230 source');ldsrcset('.un231 source');ldsrcset('.un232 source');ldsrcset('.un233 source');ldsrcset('.un234 source');ldsrcset('.un235 source');ldsrcset('.un236 source');ldsrcset('.un237 source');ldsrcset('.un238 source');};if(document.readyState=="complete"){lfn();}else{$(window).on("load",lfn);}