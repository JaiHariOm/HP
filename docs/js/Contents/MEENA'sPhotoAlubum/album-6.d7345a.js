...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.js372');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'../../images/00000315-296.jpg':'../../images/00000315-148.jpg');
...
var e=document.querySelector('.js370');e.setAttribute('src',(dpi>1)?'../../images/shapeimage_4-1264.jpg':'../../images/shapeimage_4-632.jpg');
...
ldsrc('.js372');ldsrcset('.js385 source');ldsrc('.js373');ldsrcset('.js386 source');ldsrc('.js376');ldsrcset('.js387 source');ldsrc('.js377');ldsrcset('.js388 source');ldsrc('.js378');ldsrcset('.js389 source');ldsrc('.js380');ldsrcset('.js390 source');ldsrc('.js381');ldsrcset('.js391 source');ldsrc('.js382');ldsrcset('.js392 source');ldsrc('.js383');ldsrcset('.js393 source');ldsrc('.js384');ldsrcset('.js394 source');
});