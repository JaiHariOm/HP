...
ldsrc('.js137');ldsrcset('.js142 source');ldsrc('.js138');ldsrcset('.js143 source');ldsrc('.js139');ldsrcset('.js144 source');ldsrc('.js140');ldsrcset('.js145 source');wl=new woolite();
wl.init();
wl.addAnimation($('.js134')[0], "1.80s", "0.00s", 8, 100);
wl.start();
