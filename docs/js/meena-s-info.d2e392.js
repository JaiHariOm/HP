...
ldsrc('.js134');ldsrcset('.js139 source');ldsrc('.js135');ldsrcset('.js140 source');ldsrc('.js136');ldsrcset('.js141 source');ldsrc('.js137');ldsrcset('.js142 source');wl=new woolite();
wl.init();
wl.addAnimation($('.js131')[0], "1.80s", "0.00s", 8, 100);
wl.start();
