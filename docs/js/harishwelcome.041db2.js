...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js513');e.setAttribute('src',(dpi>1)?'images/harishbg-1920.jpg':'images/harishbg-960.jpg');
...
ldsrcset('.js522 source');ldsrcset('.js523 source');ldsrcset('.js524 source');wl=new woolite();
wl.init();
wl.addAnimation($('.js518'), "1.00s", "0.00s", 8, 100);
wl.start();
