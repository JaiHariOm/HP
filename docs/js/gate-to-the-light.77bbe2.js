...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.js559');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/img_8430-1314.jpeg':'images/img_8430-657.jpeg');
var a='data-src';var e=document.querySelector('.js560');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/hua-xiang-3-1058.jpg':'images/hua-xiang-3-529.jpg');
var a='data-src';var e=document.querySelector('.js562');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/godsgarden-logo6-400-1.png':'images/godsgarden-logo6-200-1.png');

var e=document.querySelector('.js553');e.setAttribute('src',(dpi>1)?'images/godsgarden-logo6-978.png':'images/godsgarden-logo6-489.png');
var e=document.querySelector('.js556');e.setAttribute('src',(dpi>1)?'images/hua-xiang-86-1070.jpg':'images/hua-xiang-86-535.jpg');};
if(!window.HTMLPictureElement){r();}
(function(){$('a[href^="#"]:not(.allowConsent,.noConsent,.denyConsent,.removeConsent)').each(function(i,e){$(e).click(function(){var t=e.hash.length>1?$('[name="'+e.hash.slice(1)+'"]').offset().top:0;return $("html, body").animate({scrollTop:t},400),!1})})})();
ldsrc('.js558');ldsrcset('.js563 source');ldsrc('.js559');ldsrcset('.js564 source');ldsrc('.js560');ldsrcset('.js565 source');ldsrc('.js562');ldsrcset('.js566 source');wl=new woolite();
wl.init();
wl.addAnimation($('.js554')[0], "2.00s", "0.00s", 1, 100);
wl.addAnimation($('.js555')[0], "3.10s", "0.00s", 1, 1);
wl.addAnimation($('.js557')[0], "3.00s", "0.00s", 1, 100);
wl.addAnimation($('.js561')[0], "3.10s", "0.00s", 1, 0);
wl.start();
