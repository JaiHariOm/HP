...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.un265');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/img_8430-1314.jpeg':'images/img_8430-657.jpeg');
var a='data-src';var e=document.querySelector('.un267');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/atisuto-878.jpg':'images/atisuto-439.jpg');

var a='data-src';var e=document.querySelector('.un269');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/godsgarden-logo6-400-1.png':'images/godsgarden-logo6-200-1.png');
var e=document.querySelector('.un261');e.setAttribute('src',(dpi>1)?'images/godsgarden-logo6-1120-1-618.png':'images/godsgarden-logo6-1120-1-309.png');};
...
wl=new woolite();
wl.init();
wl.addAnimation($('.un262'), "3.10s", "0.00s", 1, 100);
wl.addAnimation($('.un263'), "3.10s", "0.00s", 1, 100);
wl.addAnimation($('.un264'), "3.10s", "1.00s", 1, 100);
wl.addAnimation($('.un266'), "1.00s", "0.00s", 1, 100);
wl.start();
if(location.hash){var e=location.hash.replace("#",""),o=function(){var t=document.querySelectorAll('[name="'+e+'"]')[0];t&&t.scrollIntoView(),"0px"===window.getComputedStyle(document.body).getPropertyValue("min-width")&&setTimeout(o,100)};o()}

});lfn=function(){ldsrcset('.un270 source');ldsrcset('.un271 source');ldsrcset('.un272 source');ldsrcset('.un273 source');};if(document.readyState=="complete"){lfn();}else{$(window).on("load",lfn);}