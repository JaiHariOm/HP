...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.un214');e.setAttribute('src',(dpi>1)?'images/godsgarden-logo6-1020.png':'images/godsgarden-logo6-510.png');
...
var a='data-src';var e=document.querySelector('.un222');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/artistphoto-816.jpg':'images/artistphoto-408.jpg');

var a='data-src';var e=document.querySelector('.un225');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/godsgarden-logo6-400.png':'images/godsgarden-logo6-200.png');};
